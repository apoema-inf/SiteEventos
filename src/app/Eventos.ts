...
export const EVENTOS: Evento[] = [
    {
        ...
        <div align="center" class="row">
            ...
            <a class="cabeca-btn waves-effect waves-light btn blue darken-3" href="">Inscrições</a>
            <a class="cabeca-btn waves-effect waves-light btn blue darken-3" href="/sessoes">Sessões Técnicas</a>
        </div>
        ...
        O evento está sendo organizado pelo INF (Instituto de Informática da UFG) e contará com palestras nacionais e internacionais de grandes pesquisadores da área de sistemas e inovação, além de apresentação de artigos e fóruns de discussão.
        <br><br>
        Serão muito bem-vindos os trabalhos desenvolvidos pela comunidade acadêmica que contemplem as seguintes linhas:
        <br><br>
        ...
        <br><br>
        Em meio a este estado de coisas, a quarta revolução industrial (conhecida como Indústria 4.0) se desponta como um celeiro tecnológico ultraconvergente que afeta a existência dos sistemas em geral e das organizações sociais e disciplinas do conhecimento, em particular. É com este espírito que este consagrado evento nacional pousa no Centro-Oeste brasileiro com a pretensão de buscar explicações, revisitar as teorias e discutir novas descobertas, além de promover espaços de interação social e redes de relacionamento, envolvendo diferentes comunidades de prática.
        <br><br>
