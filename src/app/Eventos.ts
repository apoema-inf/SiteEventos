...
export const EVENTOS: Evento[] = [
    ...
    {
        id: 'ersi-go',
        nome: 'Escola Regional de Sistemas de Informação',
        imgvertical: "../assets/images/ersigo-vertical.png",
        imghorizontal: '../assets/images/ersigo-horizontal.png',
        data: 'Novembro 2018',
        publicoalvo: 'Estudantes do Ensino Médio',
        local: 'Instituto de Informática',
        coordenador: 'Profª Nádia Félix',
        sinopse: 'A Escola Regional de Sistemas de Informação de Goiás'+
        ' (ERSI-GO) é um evento técnico-científico, cujo objetivo principal'+
        ' é reunir estudantes, professores, pesquisadores e profissionais '+
        'de Sistemas de Informação para promover discussões acerca dos temas'+
        ' centrais de SI, envolvendo aspectos educacionais, tecnológicos e organizacionais.'+
        ' A ERSI-GO traz como tema a tríade "ciência, tecnologia e mercado".'+
        ' O tema deste ano busca aprofundar as discussões sobre o papel dos profissionais '+
        'de Sistemas de Informação na sociedade, bem como a importância de haver cooperação'+
